...
Only the latest published version of Relay receives security fixes.
...
- Steps to reproduce
- Your VS Code and Relay versions

You can expect an acknowledgement within 72 hours and a fix or mitigation plan within 14 days for confirmed issues.

## Scope

Relay runs entirely locally — there is no backend, no telemetry, and no data leaves your machine except:
