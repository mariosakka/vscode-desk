...
## [1.1.0](https://github.com/mariosakka/vscode-desk/compare/v1.0.0...v1.1.0) (2026-06-25)
...
* add testId to bookmark remove button and update e2e test for confirm flow ([c6fed63](https://github.com/mariosakka/vscode-desk/commit/c6fed63002950363293ed58d2e5ceb28c310deba))
* bookmark remove testid and e2e confirm flow ([65b1b5f](https://github.com/mariosakka/vscode-desk/commit/65b1b5fb3e2fcafb42ffd9714534e6e5f4be59fd))
...
* remove duplicate MCP tool definitions ([e0df081](https://github.com/mariosakka/vscode-desk/commit/e0df0810003f60e8db0c2d89141edd568babbaeb))
...
* remove duplicate tool definitions from toolSchemas ([96e9d15](https://github.com/mariosakka/vscode-desk/commit/96e9d15b0b20aa69870b59a0edc157500772578a))
...
* update all stale Relay/Astrolabe references in e2e tests and page viewer ([6a1a887](https://github.com/mariosakka/vscode-desk/commit/6a1a88776b41b09fde14e3e1e285bce068e26da1))
* update stale Relay/Astrolabe references in e2e tests and page viewer ([1dab0b5](https://github.com/mariosakka/vscode-desk/commit/1dab0b5889d2e6168efb805bbcb42cf73d6e6923))
